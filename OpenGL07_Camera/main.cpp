...
int main() {
	...
	//着色器
	Shader myshader("7.1.camera.vs", "7.1.camera.fs");
	//顶点
	float vertices[] = {
	...
	while (!glfwWindowShouldClose(window)) {
		...
		//view = glm::lookAt(glm::vec3(camX, 2, camZ),//相机位置cameraPos
		//					glm::vec3(0.0,0.0,0.0),//目标位置 cameraPos + cameraFront
		//					glm::vec3(0.0, 1.0, 0.0));//空间中方向向上的向量 cameraUp
		...
		//unsigned int proLoc = glGetUniformLocation(myshader.ID, "projection");
